...
async def send_to_odoo(req: SendToOdooRequest):
    ...
    # Şirket sadece kullanıcı "Yeni Kontak Oluştur" deyip onayladıysa aranır/oluşturulur
    # selected_contact_id = None ama card_fields doluysa yeni kontak onaylanmış demektir
    create_new_contact = (req.selected_contact_id is None) and bool(cf.get('name'))
    if create_new_contact and not company_id and company_name:
    ...
    # ── D. Görüşülen kişiler ─────────────────────────────────────────────────
    def find_or_create(name, phone='', email='', parent=None, extra_data=None, manual_fields=None):
    ...
    if req.selected_gorusulen_1_id:
        ...
        g1 = find_or_create(ff['gorusulen_1'],
            ...
            extra_data=req.gorusulen_1_data, manual_fields=mf)
    ...
    if req.selected_gorusulen_2_id:
        ...
        g2 = find_or_create(ff['gorusulen_2'],
            ...
            extra_data=req.gorusulen_2_data, manual_fields=mf)
    ...
    if req.selected_gorusulen_3_id:
        ...
        g3 = find_or_create(ff['gorusulen_3'],
            ...
            extra_data=req.gorusulen_3_data, manual_fields=mf)
